    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmbroideryTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmbroideryTypes", x => x.EmbroideryTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    EmbroideryTypeId = table.Column<int>(type: "int", nullable: true),
                    Country = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Story = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HistoricalBackground = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Occasion = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_EmbroideryTypes_EmbroideryTypeId",
                        column: x => x.EmbroideryTypeId,
                        principalTable: "EmbroideryTypes",
                        principalColumn: "EmbroideryTypeId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmbroideryTypes_Name",
                table: "EmbroideryTypes",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_EmbroideryTypeId",
                table: "Products",
                column: "EmbroideryTypeId");
